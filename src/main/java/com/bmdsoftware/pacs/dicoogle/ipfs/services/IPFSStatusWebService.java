 ...
 */
public class IPFSStatusWebService extends HttpServlet implements PlatformCommunicatorInterface {
    private static final Logger logger = LoggerFactory.getLogger(IPFSStatusWebService.class);

    private DicooglePlatformInterface platform;
    private IPFS ipfs = null;

    public IPFSStatusWebService(IPFS ipfs) {
        this.ipfs = ipfs;
    }
